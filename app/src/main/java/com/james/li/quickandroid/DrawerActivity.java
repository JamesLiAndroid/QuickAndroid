			...
			public boolean onNavigationItemSelected(@NonNull MenuItem item) {
				switch (item.getItemId()) {
					case R.id.action_index:
						Toast.makeText(com.james.li.quickandroid.DrawerActivity.this, "index", Toast.LENGTH_SHORT).show();
						imgIndex.setVisibility(View.VISIBLE);
						imgNext.setVisibility(View.GONE);
						imgThird.setVisibility(View.GONE);
						break;
					case R.id.action_next:
						Toast.makeText(com.james.li.quickandroid.DrawerActivity.this, "Next", Toast.LENGTH_SHORT).show();
						imgIndex.setVisibility(View.GONE);
						imgNext.setVisibility(View.VISIBLE);
						imgThird.setVisibility(View.GONE);
						break;
					case R.id.action_third:
						Toast.makeText(com.james.li.quickandroid.DrawerActivity.this, "Third", Toast.LENGTH_SHORT).show();
						imgIndex.setVisibility(View.GONE);
						imgNext.setVisibility(View.GONE);
